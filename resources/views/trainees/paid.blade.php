...
@section('page-title', 'Paid Trainees')
    ...
    <div class="slt-container py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="page-header-trainee">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="page-title-trainee">Paid Trainees</h1>
        ...
        <div class="card filter-card">
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <ul class="nav nav-pills nav-pills-custom mb-0">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/trainees/active') }}">Active Trainees</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/trainees/inactive') }}">Inactive Trainees</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ url('/trainees/paid') }}">Paid Trainees</a>
                    </li>
                </ul>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr data-trainee-id="{{ $trainee->Trainee_ID }}" data-trainee-name="{{ $trainee->Trainee_Name }}">
                            ...
                            <td><span class="date-badge">{{ $trainee->requested_payment_date ? $trainee->requested_payment_date->format('Y-m-d') : '-' }}</span></td>
                            <td><span class="date-badge">{{ $trainee->payment_start_date ? $trainee->payment_start_date->format('Y-m-d') : '-' }}</span></td>
                            <td><span class="date-badge">{{ $trainee->payment_end_date ? $trainee->payment_end_date->format('Y-m-d') : '-' }}</span></td>
                            <td>
                        ...
                        <tr>
                            <td colspan="10" class="text-center py-4">
                                <p class="text-muted">No paid trainees found.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="card pagination-card">
            <div class="card-body">
                <div class="d-flex justify-content-center align-items-center gap-3">
                    <span class="text-muted">Showing 1 to 3 of 100 entries</span>
                    <nav>
            ...
            <div class="modal-body" style="padding: 30px;">
                <form id="createTraineeForm">
                    <div class="row g-3">
                        ...
                        <!-- Payment Amount -->
                        <div class="col-md-6">
                            <label for="traineePayment" class="form-label" style="font-weight: 600; color: #334155;">Payment Amount (LKR)</label>
                            <input type="number" class="form-control" id="traineePayment" required style="border: 2px solid #e2e8f0; border-radius: 10px; padding: 10px 15px;">
                        </div>

                        <!-- Payment Date -->
                        <div class="col-md-6">
                            <label for="paymentDate" class="form-label" style="font-weight: 600; color: #334155;">Payment Date</label>
                            <input type="date" class="form-control" id="paymentDate" required style="border: 2px solid #e2e8f0; border-radius: 10px; padding: 10px 15px;">
                        </div>
                        ...
                        <!-- Digital Link -->
                        <div class="col-12">
                            <label for="traineeDigitalLink" class="form-label" style="font-weight: 600; color: #334155;">Digital Link</label>
                            <input type="url" class="form-control" id="traineeDigitalLink" placeholder="https://" style="border: 2px solid #e2e8f0; border-radius: 10px; padding: 10px 15px;">
                        </div>
                    </div>
