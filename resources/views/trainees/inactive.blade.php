...
@section('page-title', 'Inactive Trainees')
    ...
    <div class="slt-container py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="page-header-trainee">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="page-title-trainee">Inactive Trainees</h1>
        ...
        <div class="card filter-card">
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <ul class="nav nav-pills nav-pills-custom mb-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ url('/trainees/inactive') }}">Inactive Trainees</a>
                    </li>
                    <li class="nav-item">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr data-trainee-id="{{ $trainee->Trainee_ID }}" data-trainee-name="{{ $trainee->Trainee_Name }}">
                            ...
                            <td><strong>{{ $trainee->field_of_specialization ?? '-' }}</strong></td>
                        ...
                        <tr>
                            <td colspan="10" class="text-center py-4">
                                <p class="text-muted">No inactive trainees found.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
