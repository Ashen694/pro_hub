            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <a href="{{ route('external-solutions.show', $solution->id) }}" class="btn btn-ghost-info btn-sm" title="View Details">
                        ...
                        <a href="{{ route('external-solutions.edit', $solution->id) }}" class="btn btn-ghost-dark btn-sm" title="Edit Documents">
                        ...
                        <a href="#" class="btn btn-ghost-secondary btn-sm ms-2" title="Comments">
