@extends('layouts.app')
@section('page-title','Create Field Of Specialization')
@section('content')
<style>
...
<div class="container">
    <div class="form-container">
        <h4 class="mb-4">Create New Field Of Specialization</h4>
        
        @if(session('success'))
            <div class="alert alert-success">{{ session('success') }}</div>
        @endif
        
        <form action="{{ route('reference-data.fields-of-specializations.store') }}" method="POST">
            @csrf
