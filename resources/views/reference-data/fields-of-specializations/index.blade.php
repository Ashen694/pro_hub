...
<style>
    ...
    .fos-table { background: #fff !important; }
    .fos-table thead th { color: #000 !important; background: #fff !important; }
    .fos-table tbody td { color: #000 !important; background: #fff !important; }
    .link-details { color: #0dcaf0; }
    /* Black visible borders */
    .fos-table, .fos-table th, .fos-table td { 
        border: 1px solid #000 !important; 
        border-collapse: collapse !important;
    }
    .fos-table tr:hover td { background: #f8f9fa !important; }
