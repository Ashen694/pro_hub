@extends('layouts.app')
@section('page-title','Create Application Group')
@section('content')
<style>
...
<div class="container">
    <div class="form-container">
        <h4 class="mb-4">Create New Application Group</h4>
        
        @if(session('success'))
            <div class="alert alert-success">{{ session('success') }}</div>
        @endif
        
        <form action="{{ route('reference-data.application-groups.store') }}" method="POST">
            @csrf
            
            <div class="mb-3">
                <label for="name" class="form-label">Application Group Name</label>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">Create Application Group</button>
            </div>
        </form>
    </div>
</div>
