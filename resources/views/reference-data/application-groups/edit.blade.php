...
<div class="container">
    <div class="form-container">
        <h4 class="mb-4">Edit Application Group</h4>
        
        @if(session('success'))
            <div class="alert alert-success">{{ session('success') }}</div>
        @endif
        
        <form action="{{ route('reference-data.application-groups.update', $group) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">Update Application Group</button>
            </div>
        </form>
    </div>
</div>
