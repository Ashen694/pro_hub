...
class ExternalSolutionFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'sales_team_involved' => $this->faker->word,
            ...
            'launched_date' => $this->faker->optional(0.6)->dateTimeBetween('-6 months','now')->format('Y-m-d'),
            ...
            'support_availability' => $this->faker->randomElement(['24x7','Business Hours','Limited']),
            'dpo_handover_date' => $this->faker->optional()->dateTimeBetween('now','+1 years')->format('Y-m-d'),
