...
class ActiveTraineesExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnWidths
{
    /**
    ...
    {
        return Trainee::active()->orderBy('Trainee_ID', 'desc')->get();
    }
